...
実際のsource file、主要関数、commandごとの実装経路は、補助文書として `docs/development/source-code-map.md` と `docs/development/command-source-trace.md` に展開する。この文書は設計の正本、補助文書はsource navigationの正本である。
