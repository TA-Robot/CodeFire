...
| CF-221 | Diagnostics | status/scan/verify/doctor/storage/migrateにmachine-readable `next_actions` を追加する | CF-208, CF-220 | todo | status/scan/verifyはdone。storage report warning next_actionsはCF-215Aでdone。doctor/migrateは各command実装後に追加する |
