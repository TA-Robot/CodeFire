...
| CF-215 | Rust Storage | storage reportとexternal artifact refsをRustで実装する | CF-202, CF-167 | todo | storage report基本版はCF-215Aでdone。artifact_ref基本版はCF-215Bでdone。retention policy、remote-aware reportは未対応 |
