...
| CF-226 | Evidence | command outputとartifact hashを取り込むevidence capture APIを実装する | CF-215, CF-218 | todo | `evidence add`基本版はCF-226Aでdone。batch evidence、remote evidence refs、verify/evidence linkageは未対応 |
