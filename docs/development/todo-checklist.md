...
| CF-223 | Batch | link/fire/extinguish/evidence/artifactのbatch操作とdry-run validationを実装する | CF-207, CF-222 | todo | extinguish batchはCF-223Aでdone。evidence/artifact batchはCF-226Bでdone。link batchは未対応 |
