...
| CF-222 | Operation Plans | mutating commandに `--dry-run` / operation plan出力を追加する | CF-209, CF-218 | todo | commit/extinguish/merge/patch importはdone。open/clone/upload/request系は未対応 |
