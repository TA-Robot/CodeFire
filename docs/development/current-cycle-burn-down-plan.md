...
|---|---:|---:|---:|---|
| CFB dogfood issues | 92 | 85 | 7 | `docs/development/bug-backlog.md` is the summary source. Detail files exist for CFB-005/010/011/018/020, CFB-023 and later, plus later generated issues; CFB-001..004/006..009/012..017/019/021/022/025 are summary-only legacy entries. |
...
| Total | 252 | 218 | 34 | This global batch is the whole known issue backlog. |
