...
| CFR-120 | global burn-down | open issueをroot cause/fix group/target version/owner module/close evidenceへ接続するmachine-readable mapとdocs consistency testを追加 | `issue_root_cause_map_covers_open_issues` |
