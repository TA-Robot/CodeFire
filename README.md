...
実装を読む場合は、上記に続けて `docs/development/source-code-map.md`、`docs/development/source-code-mental-model.md`、`docs/development/command-source-trace.md` を読むと、command、module、主要関数、データ流、persistent stateの対応を把握できます。
