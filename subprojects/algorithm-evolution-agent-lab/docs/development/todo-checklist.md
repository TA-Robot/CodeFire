...
| AE-098 | Reporting | planning handoff review packetを最終レビュー用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-markdown-renders-review-document`; 162 tests pass |
| AE-099 | Reporting | planning handoff review packetを保存用artifact setへまとめる | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactBuilder`; `TEST-research-cycle-planning-handoff-review-packet-artifact-builder-packages-audits`; 163 tests pass |
| AE-100 | Reporting | planning handoff review packet artifact setのmanifestを生成する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactManifestBuilder`; `TEST-research-cycle-planning-handoff-review-packet-artifact-manifest-records-artifacts`; 164 tests pass |
| AE-101 | Reporting | planning handoff review packet artifact manifestを監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactManifestMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-manifest-markdown-renders-table`; 165 tests pass |
| AE-102 | Planning QA | planning handoff review packet artifact manifestとartifact内容のdriftを検出する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactManifestVerifier`; `TEST-research-cycle-planning-handoff-review-packet-artifact-manifest-verifier-detects-drift`; 166 tests pass |
| AE-103 | Reporting | planning handoff review packet artifact manifest verification結果を監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactManifestVerificationMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-manifest-verification-markdown-renders-findings`; 167 tests pass |
| AE-104 | Reporting | planning handoff review packet artifact、manifest、verification、監査Markdownを最終archiveへまとめる | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveBuilder`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-builder-builds-final-audits`; 168 tests pass |
| AE-105 | Reporting | planning handoff review packet artifact archiveをmachine-readable summaryへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummary`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-reports-index`; 169 tests pass |
| AE-106 | Reporting | planning handoff review packet artifact archive summaryを監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-markdown-renders-index`; 170 tests pass |
| AE-107 | Planning QA | planning handoff review packet artifact archive summary Markdownのhandoff readinessを判定する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryMarkdownGate`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-markdown-gate-blocks-drift`; 171 tests pass |
| AE-108 | Reporting | planning handoff review packet artifact archive summary Markdown gate結果を監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryMarkdownGateMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-markdown-gate-markdown-renders-blockers`; 172 tests pass |
| AE-109 | Reporting | planning handoff review packet artifact archive summaryとgate監査をartifact setへまとめる | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactBuilder`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-builder-packages-gated-summary`; 173 tests pass |
| AE-110 | Reporting | planning handoff review packet artifact archive summary artifact setのmanifestを生成する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactManifestBuilder`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-manifest-records-summary-artifacts`; 174 tests pass |
| AE-111 | Reporting | planning handoff review packet artifact archive summary artifact manifestを監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactManifestMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-manifest-markdown-renders-table`; 175 tests pass |
| AE-112 | Planning QA | planning handoff review packet artifact archive summary artifact manifestとartifact内容のdriftを検出する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactManifestVerifier`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-manifest-verifier-detects-drift`; 176 tests pass |
| AE-113 | Reporting | planning handoff review packet artifact archive summary artifact manifest verification結果を監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactManifestVerificationMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-manifest-verification-markdown-renders-findings`; 177 tests pass |
| AE-114 | Reporting | planning handoff review packet artifact archive summary artifact、manifest、verification、監査Markdownを最終summary archiveへまとめる | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactArchiveBuilder`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-archive-builder-builds-audits`; 178 tests pass |
| AE-115 | Reporting | planning handoff review packet artifact archive summary artifact archiveをmachine-readable indexへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactArchiveSummary`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-archive-summary-reports-index`; 179 tests pass |
| AE-116 | Reporting | planning handoff review packet artifact archive summary artifact archive summaryを監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactArchiveSummaryMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-archive-summary-markdown-renders-index`; 180 tests pass |
| AE-117 | Planning QA | planning handoff review packet artifact archive summary artifact archive summary Markdownのhandoff readinessを判定する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactArchiveSummaryMarkdownGate`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-archive-summary-markdown-gate-blocks-drift`; 181 tests pass |
| AE-118 | Reporting | planning handoff review packet artifact archive summary artifact archive summary Markdown gate結果を監査用Markdownへ整形する | done | `CODE-ResearchCyclePlanningHandoffReviewPacketArtifactArchiveSummaryArtifactArchiveSummaryMarkdownGateMarkdown`; `TEST-research-cycle-planning-handoff-review-packet-artifact-archive-summary-artifact-archive-summary-markdown-gate-markdown-renders-blockers`; 182 tests pass |
